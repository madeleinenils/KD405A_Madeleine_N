...
public class TestClass {
	...
	public static void main(String[] args) {
		//gets start station number, end station number and result number from Constants
		String searchURL = Constants.getURL("80000","81216",20); //Malmö C = 80000,  Lund C, 81216 Malmö Gatorg 80100, H�ssleholm C 93070
		System.out.println(searchURL);
		System.out.println("// Results when searching:");
		
		//imports from Journey URL
	   ...
	   //makes arraylist from all search stations
		ArrayList<Station> searchStations = new ArrayList<Station>(); 
		//gets all stations from URL 
